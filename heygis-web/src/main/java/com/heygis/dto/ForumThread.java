...
public class ForumThread {
    ...
    public ForumThread(int tid, int fid, int typeid, int sortid, String author,
                       ...
                       Date lastpost, String lastposter, int lastposterUid, int views, int replies,
    ...
    public int getLastposterUid() {
        return lastposterUid;
    }

    public void setLastposterUid(int lastposterUid) {
        this.lastposterUid = lastposterUid;
    }
}
