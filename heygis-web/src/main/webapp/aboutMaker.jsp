...
<html>
	...
	<pre class="text-left">
	联系方式如下：<br>
	int[] arr = new int[]{7,6,1,5,4,2,9};<br>
	int[] index = new int[]{2,3,1,0,4,6,5,4,2,5,2};<br>
	String tel = "";<br>
	for(int i : index){<br>
		tel += arr[i];<br>
	}<br>
	System.out.println("联系方式："+tel);
							...
							<!--button class="btn btn-primary" id="xjc">点击查看详情</button-->
						</div>
					</div>
					<div class="col-md-6">
						<div class="boxsha">
	...
	<pre class="text-left">
	联系方式如下：<br>
	int[] arr = new int[]{7,4,9,1,8,5};<br>
	int[] index = new int[]{3,5,5,0,1,2,1,1,4,0,2};<br>
	String tel = "";<br>
	for(int i : index){<br>
		tel += arr[i];<br>
	}<br>
	System.out.println("联系方式："+tel);
							...
							<!--button class="btn btn-primary" id="yrc">点击查看详情</button-->
						</div>
					</div>
				</div>
			</div>
		</div>
		<div id="sampledata1" class="bringins-content" style="color:whitesmoke">
		<!--h2>javascript</h2>
		...
		<div id="sampledata2" class="bringins-content" style="color:white">
		<h2>jQuery</h2>
